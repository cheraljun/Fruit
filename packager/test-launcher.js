...
const paths = {
  ...
  'backend/dist/backend/src/app.js': path.join(simulatedAppDir, 'backend', 'dist', 'backend', 'src', 'app.js'),
  'backend/dist/shared': path.join(simulatedAppDir, 'backend', 'dist', 'shared'),
  'frontend/dist': path.join(simulatedAppDir, 'frontend', 'dist'),
  'shared/package.json': path.join(simulatedAppDir, 'shared', 'package.json'),
};
