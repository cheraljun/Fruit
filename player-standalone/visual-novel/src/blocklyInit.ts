...
import { BlocklyPlugin } from '@frontend/plugins/basicmod/BlocklyPlugin';
import { ALL_GAMEMOD_BLOCKS, ALL_GAMEMOD_GENERATORS } from '@frontend/plugins/gamemods/blockly';
import { 
  registerCustomBlocks, 
  registerCodeGenerators, 
  overrideVariableBlockGenerators, 
  injectCodeGenerator 
} from '@frontend/blockly/BlocklyCore';
...
export function initializeBlockly(): void {
  ...
  registerCustomBlocks([...blockDefinitions.story, ...ALL_GAMEMOD_BLOCKS]);

  // ============= 3. 注册代码生成器（基础 + 游戏模组）=============
  registerCodeGenerators({ ...codeGenerators, ...ALL_GAMEMOD_GENERATORS });
