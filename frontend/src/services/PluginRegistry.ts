...
export const PLUGIN_REGISTRY: Record<string, PluginDetail> = {
  ...
  'tool.export-html': {
    ...
    longDescription: '导出插件可以将你的故事打包成单个HTML文件，包含完整的播放器和所有资源。导出的文件可以直接分享，不需要服务器。支持黑色终端和白色简洁两种样式。',
    usage: '在仪表盘中点击作品的"导出HTML"按钮，然后选择样式。',
    category: 'export',
    icon: 'EXP'
  },
  
  'player-style.dark-terminal': {
    id: 'player-style.dark-terminal',
    name: '黑色终端风格',
    description: '经典黑色终端，绿色系统信息，适合技术向作品',
    longDescription: '经典黑色终端风格，使用黑色背景和绿色系统信息，营造复古终端氛围。适合科幻、赛博朋克等技术向作品。试玩和导出共享此样式。',
    usage: '启用后，试玩页面和导出的HTML文件都将使用黑色终端样式。与白色简洁风格互斥，只能启用一个。',
    category: 'enhance',
    icon: 'DARK'
  },
  
  'player-style.light-clean': {
    id: 'player-style.light-clean',
    name: '白色简洁风格',
    description: '明亮白色背景，深色文字，适合阅读向作品',
    longDescription: '明亮的白色简洁风格，使用白色背景和深色文字，提供清晰的阅读体验。适合文学、推理等阅读向作品。试玩和导出共享此样式。',
    usage: '启用后，试玩页面和导出的HTML文件都将使用白色简洁样式。与黑色终端风格互斥，只能启用一个。',
    category: 'enhance',
    icon: 'LIGHT'
  },
