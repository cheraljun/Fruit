...
import type { VariableDefinition, Character } from '../../../shared/types/index.js';
...
function ScriptHelper({ variables, characters, onVariablesChange }: ScriptHelperProps): JSX.Element {
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        {characters && characters.length > 0 && (
          <div>
            ...
            >
              {expandedSection === 'characters' ? '▼' : '▶'} 角色对话 ({characters.length}个)
            </button>
              ...
              <div style={{ 
                ...
                {characters.map(char => (
                  ...
                  >
                    ...
                    <code style={{ fontSize: '0.75rem' }}>@{char.name}：</code>
                  </div>
                ))}
              </div>
            )}
